  ...
  return (
    <View style={styles.page}>
      <View style={styles.pageLogin}>
        ...
        <TouchableOpacity onMouseEnter={() => setIsLoginButtonHover(true)} onMouseLeave={() => setIsLoginButtonHover(false)} style={styles.defaultButton} > Register </TouchableOpacity>
        </View>
      </View>
